...
<body>
  ...
  <form action="update_profile.php" method="post">
    ...
    <div class="form-group">
      ...
      <input type="number" name="age" id="age" min="13">
    </div>
    <div class="form-group">
      <label for="current_password">Current Password:</label>
      <input type="password" name="current_password" id="current_password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
