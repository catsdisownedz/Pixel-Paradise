...
Mario.Level.prototype = {
  ...
  IsBlocking: function (x, y, xa, ya) {
    ...
    var blocking =
      (Mario.Tile.Behaviors[block & 0xff] & Mario.Tile.BlockAll) > 0;
    blocking |=
      ya > 0 &&
      (Mario.Tile.Behaviors[block & 0xff] & Mario.Tile.BlockUpper) > 0;
    blocking |=
      ya < 0 &&
      (Mario.Tile.Behaviors[block & 0xff] & Mario.Tile.BlockLower) > 0;
