// Template for an enemy in the game
        ...
        if (this.Winged) {
          ...
          if (this.Type === Mario.Enemy.RedKoopa) {
            this.World.AddSprite(
              new Mario.Shell(this.World, this.X, this.Y, 0)
            );
          } else if (this.Type === Mario.Enemy.GreenKoopa) {
            this.World.AddSprite(
              new Mario.Shell(this.World, this.X, this.Y, 1)
            );
          }
        }
      } else {
...
Mario.Enemy.prototype.Draw = function (context, camera) {
  ...
  if (this.Winged) {
    ...
    if (
      this.Type !== Mario.Enemy.RedKoopa &&
      this.Type !== Mario.Enemy.GreenKoopa
    ) {
      ...
      context.drawImage(
        ...
        16,
        32,
        this.XFlip ? 320 - xPixel - 24 : xPixel - 8,
        this.YFlip ? 240 - yPixel - 32 : yPixel - 8,
        16,
        32
      );
      context.restore();
  ...
  if (this.Winged) {
    ...
    if (
      ...
      context.drawImage(
        ...
        32,
        this.XFlip ? 320 - xPixel - 24 : xPixel - 8,
        this.YFlip ? 240 - yPixel : yPixel - 8,
        16,
        32
      );
      context.restore();
