var Mario = {
    ...
    GetBackgroundSheet: function () {
      for (
        var a = [],
          b = 0,
          c = 0,
          e = Engine.Resources.Images.background.width / 32,
          d = Engine.Resources.Images.background.height / 32,
          b = 0;
        b < e;
        b++
      ) {
    ...
    GetLevelSheet: function () {
      for (
        var a = [],
          b = 0,
          c = 0,
          e = Engine.Resources.Images.map.width / 16,
          d = Engine.Resources.Images.map.height / 16,
          b = 0;
        b < e;
        b++
      ) {
  ...
  Tile: {
    ...
    LoadBehaviors: function () {
      for (
        var a = [
            0, 20, 28, 0, 130, 130, 130, 130, 2, 2, 2, 2, 2, 0, 138, 0, 162,
            146, 154, 162, 146, 146, 154, 146, 2, 0, 2, 2, 2, 0, 2, 0, 192, 192,
            192, 192, 0, 0, 0, 0, 2, 2, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0,
            0, 2, 2,
          ],
          b = 0,
          b = 58;
...
Mario.ImprovedNoise.prototype = {
  ...
  PerlinNoise: function (a, b) {
    for (var c = 0, e = 0, d = 0, c = 0; c < 8; c++)
      (d = 64 / (1 << c)), (e += this.Noise(a / d, b / d, 128) / (1 << c));
    return e;
  },
...
Mario.Character.prototype.Blink = function (a) {
  ...
  this.Large
    ? ((this.Image = this.Fire
        ? Engine.Resources.Images.fireMario
        : Engine.Resources.Images.mario),
      (this.XPicO = 16),
      (this.YPicO = 31),
...
Mario.Character.prototype.Move = function () {
  if (this.WinTime > 0) this.WinTime++, (this.Ya = this.Xa = 0);
    ...
    if (this.OnGround)
      this.Ducking =
        Engine.KeyboardInput.IsKeyDown(Engine.Keys.Down) && this.Large
          ? !0
          : !1;
    ...
    if (
      ...
      this.Carried.Release(this), (this.Carried = null);
  }
};
Mario.Character.prototype.CalcPic = function () {
  ...
  this.Large
    ? ((a = ((this.RunTime / 20) | 0) % 4),
      ...
      this.OnGround ||
        (a = this.Carried !== null ? 12 : Math.abs(this.Xa) > 10 ? 7 : 6))
    : ((a = ((this.RunTime / 20) | 0) % 2),
      this.Carried === null && Math.abs(this.Xa) > 10 && (a += 2),
      this.Carried !== null && (a += 8),
      this.OnGround ||
        (a = this.Carried !== null ? 9 : Math.abs(this.Xa) > 10 ? 5 : 4));
  if (
    this.OnGround &&
...
Mario.Character.prototype.SubMove = function (a, b) {
  ...
  if (b < 0)
    if (this.IsBlocking(this.X + a, this.Y + b - this.Height, a, b)) c = !0;
      ...
      c ||
      this.IsBlocking(this.X + a - this.Width, this.Y + b - this.Height, a, b)
    )
      c = !0;
    else if (
      c ||
  ...
  if (c) {
    ...
    if (b > 0)
      (this.Y = (((this.Y - 1) / 16 + 1) | 0) * 16 - 1), (this.OnGround = !0);
    return !1;
...
Mario.Character.prototype.IsBlocking = function (a, b, c, e) {
  ...
  (d = this.World.Level.IsBlocking(a, b, c, e)) &&
    e < 0 &&
...
Mario.Character.prototype.GetHurt = function () {
  if (
    !(this.DeathTime > 0 || this.World.Paused) &&
...
Mario.Character.prototype.GetFlower = function () {
  if (!(this.DeathTime > 0 && this.World.Paused))
    this.Fire
      ? (this.GetCoin(), Engine.Resources.PlaySound("coin"))
      : ((this.World.Paused = !0),
        (this.PowerUpTime = 18),
...
Mario.Character.prototype.Kick = function (a) {
  if (!(this.DeathTime > 0 && this.World.Paused))
    Engine.KeyboardInput.IsKeyDown(Engine.Keys.A)
      ? ((this.Carried = a), (a.Carried = !0))
      : (Engine.Resources.PlaySound("kick"), (this.InvulnerableTime = 1));
};
...
Mario.LevelRenderer.prototype.DrawDynamic = function (a, b) {
  for (
    var c = 0, e = 0, d = 0, f = 0, g = 0, d = null, c = (b.X / 16) | 0;
    (c <= (b.X + this.Width) / 16) | 0;
    c++
  )
...
Mario.LevelRenderer.prototype.DrawExit0 = function (a, b, c) {
  for (
    var e = 0, e = 0, d = null, e = this.Level.ExitY - 8;
    e < this.Level.ExitY;
    e++
  )
...
Mario.LevelGenerator.prototype = {
  CreateLevel: function (a, b) {
    ...
    this.Type !== Mario.LevelType.Overground &&
    ...
    if (a === Mario.LevelType.Castle || a === Mario.LevelType.Underground)
      for (d = 0; d < i.Width; d++) {
        h-- <= 0 &&
          d > 4 &&
          ((g = (Math.random() * 4) | 0), (h = ((Math.random() * 4) | 0) + 4));
  ...
  BuildZone: function (a, b, c) {
    for (
      var e = (Math.random() * this.TotalOdds) | 0, d = 0, f = 0, f = 0;
      f < this.Odds.length;
      f++
    )
      this.Odds[f] <= e && (d = f);
    ...
    for (h = b; h < b + e; h++) {
      ...
      h === f &&
        ...
        a.SetSpriteTemplate(
          h,
          g,
          new Mario.SpriteTemplate(Mario.Enemy.Flower, !1)
        );
  ...
  Blockify: function (a, b, c, e) {
    for (
      var d = 0, f = [], g = 0, h = 0, i = 0, j = 0, k = (g = 0), l = 0, g = 0;
      g < 2;
      g++
    )
      f[g] = [];
    this.Type === Mario.LevelType.Castle
      ? (d = 8)
      : this.Type === Mario.LevelType.Underground && (d = 12);
    for (g = 0; g < c; g++)
      for (h = 0; h < e; h++) {
        for (i = g; i <= g + 1; i++)
          for (j = h; j <= h + 1; j++)
  ...
  if (!this.Carried && !(this.Dead || this.DeadTime > 0)) {
    ...
    if (
      ...
      (!Mario.MarioCharacter.OnGround || !Mario.MarioCharacter.WasOnGround)
        ? (Mario.MarioCharacter.Stomp(this),
          (this.Facing =
            this.Facing !== 0 ? (this.Xa = 0) : Mario.MarioCharacter.Facing))
        : this.Facing !== 0
        ? Mario.MarioCharacter.GetHurt()
...
Mario.Shell.prototype.Move = function () {
  ...
  if (this.Carried) this.World.CheckShellCollide(this);
    ...
    if (!this.SubMove(this.Xa, 0))
      Engine.Resources.PlaySound("bump"), (this.Facing = -this.Facing);
    this.OnGround = !1;
    this.SubMove(0, this.Ya);
    this.Ya *= 0.85;
    this.Xa *= this.OnGround ? this.GroundInertia : this.AirInertia;
...
Mario.Shell.prototype.ShellCollideCheck = function (a) {
  ...
  if (b > -16 && b < 16 && c > -this.Height && c < a.Height) {
    Engine.Resources.PlaySound("kick");
    if (
      Mario.MarioCharacter.Carried === a ||
...
Mario.MapState.prototype.Connect = function (a, b, c, e) {
  for (
    var d = 1e4, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, h = (j = 0);
    h < c;
    h++
  )
    for (i = 0; i < e; i++)
      this.Level[h][i] === Mario.MapTile.Level &&
        this.Data[h][i] === -2 &&
        ((j = Math.abs(a - h) | 0),
        (k = Math.abs(b - i) | 0),
        (j = j * j + k * k),
...
Mario.MapState.prototype.DrawRoad = function (a, b, c, e) {
  ...
  if (d) {
    for (; a > c; )
      (this.Data[a][b] = 0), (this.Level[a--][b] = Mario.MapTile.Road);
    for (; a < c; )
      (this.Data[a][b] = 0), (this.Level[a++][b] = Mario.MapTile.Road);
  }
  for (; b > e; )
...
Mario.MapState.prototype.RenderStatic = function () {
  for (
    var a = 0,
      ...
      g = (c = 0),
      h = 0,
      i = Engine.Resources.Images.worldMap,
      a = (g = 0);
    a < 20;
    a++
  )
...
Mario.MapState.prototype.IsWater = function (a, b) {
  ...
  for (c = 0; c < 2; c++)
    for (e = 0; e < 2; e++)
      if (
        this.Level[((a + c) / 2) | 0][((b + e) / 2) | 0] !== Mario.MapTile.Water
      )
        return !1;
  return !0;
};
...
Mario.MapState.prototype.TryWalking = function (a, b) {
  var c = (this.XMario / 16) | 0,
    ...
    f = e + b;
  if (
    (this.Level[d][f] === Mario.MapTile.Road ||
      this.Level[d][f] === Mario.MapTile.Level) &&
    !(
      this.Level[d][f] === Mario.MapTile.Road &&
      this.Data[d][f] !== 0 &&
      this.Data[c][e] !== 0 &&
...
Mario.MapState.prototype.CheckForChange = function (a) {
  ...
  this.EnterLevel &&
    a.ChangeState(new Mario.LevelState(this.LevelDifficulty, this.LevelType));
};
...
Mario.LevelState.prototype.Enter = function () {
  var a = 0,
    ...
    e = 0,
    c = null;
  this.Level = new Mario.LevelGenerator(320, 15).CreateLevel(
    this.LevelType,
...
Mario.LevelState.prototype.Update = function (a) {
  ...
  if (this.Paused)
    ...
    this.Tick++;
    for (
      c = ((this.Camera.X / 16) | 0) - 1;
      c <= (((this.Camera.X + this.Layer.Width) / 16) | 0) + 1;
      c++
    )
      for (
        e = ((this.Camera.Y / 16) | 0) - 1;
        e <= (((this.Camera.Y + this.Layer.Height) / 16) | 0) + 1;
        e++
      ) {
        d = 0;
        ...
        if (f !== null)
          f.LastVisibleTick !== this.Tick - 1 &&
            (f.Sprite === null || !this.Sprites.Contains(f.Sprite)) &&
            f.Spawn(this, c, e, d),
            (f.LastVisibleTick = this.Tick);
        if (
          d !== 0 &&
          ((f = this.Level.GetBlock(c, e)),
          (Mario.Tile.Behaviors[f & 255] & Mario.Tile.Animated) > 0 &&
            (((f % 16) / 4) | 0) === 3 &&
            ((f / 16) | 0) === 0 &&
            (this.Tick - c * 2) % 100 === 0)
        ) {
          ...
          this.AddSprite(
            new Mario.BulletBill(this, c * 16 + 8 + d * 8, e * 16 + 15, d)
          );
          b = !0;
        }
      }
    ...
    for (
      b = this.ShellsToCheck.length = 0;
      b < this.FireballsToCheck.length;
      b++
    )
      for (c = 0; c < this.Sprites.Objects.length; c++)
...
Mario.LevelState.prototype.Bump = function (a, b, c) {
  ...
  if (
    (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Breakable) > 0 &&
...
Mario.LevelState.prototype.BumpInto = function (a, b) {
  var c = this.Level.GetBlock(a, b),
    e = 0;
  (Mario.Tile.Behaviors[c & 255] & Mario.Tile.PickUpable) > 0 &&
    (Mario.MarioCharacter.GetCoin(),
    Engine.Resources.PlaySound("coin"),
    this.Level.SetBlock(a, b, 0),
...
Mario.LevelState.prototype.CheckForChange = function (a) {
  this.GotoLoseState
    ? a.ChangeState(new Mario.LoseState())
